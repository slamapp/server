...
public class UserController {
	...
	public ResponseEntity<MyProfileUpdateResponse> addExtraUserInfo(@UserId Long userId, @RequestBody ExtraUserInfoRequest extraUserInfoRequest) {
	...
	public ResponseEntity<ProfileImageResponse> updateUserProfileImage(
		@UserId Long userId, @RequestPart("profileImage") MultipartFile profileImageRequest) throws IOException {
