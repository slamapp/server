...
//			.updatedAt(LocalDateTime.now())
//			.build();
//		MyProfileUpdateResponse response = MyProfileUpdateResponse.builder()
...
//			.updatedAt(LocalDateTime.now())
//			.build();
//		MyProfileLookUpResponse response = MyProfileLookUpResponse.builder()
//			.user(DefaultUserDto.toDto(user))
//			.followerCount(325L)
//			.followingCount(118L)
//			.build();
...
//			.updatedAt(LocalDateTime.now())
//			.build();
//		ProfileImageResponse response = ProfileImageResponse.of(user);
//
